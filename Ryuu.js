...
dtod = 'ngetes'
uwu = '```'
stst = await XyudaMd.getStatus(`${sender.split('@')[0]}@c.us`)
...
XyudaMd.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:mek})
break
case 'allmenu':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
if (isBanned) return reply('Kamu Sudah Di banned!')
